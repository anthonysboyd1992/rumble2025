<div class="bg-zinc-900 rounded-xl p-6 border border-zinc-800">
    <h2 class="text-xl font-bold text-red-400 mb-4">Reset Data</h2>
    ...
    @if($showConfirm)
        <p class="text-zinc-300 mb-4">Are you sure? This will delete all entries, sessions, and results. User accounts will be preserved.</p>
