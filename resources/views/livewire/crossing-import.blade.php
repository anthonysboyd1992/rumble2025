<div class="rumble-dark-bg rounded-xl p-6 rumble-border">
    <h2 class="text-xl font-bold rumble-blue mb-4">Import Crossing CSV</h2>
    ...
    <form wire:submit="import" class="space-y-4">
        ...
        <div>
            ...
            >
            <p class="text-zinc-500 text-xs mt-1">Columns: Index, No., Name, Trns ID, Laptime, Speed, Hits/Power, Misc</p>
        </div>

        <button type="submit" class="w-full rumble-blue-bg text-white font-bold py-3 px-6 rounded-lg transition-colors">
            Import Crossing Times
        </button>
    </form>
